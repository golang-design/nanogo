...
// Source: ../upstream/types2/api_test.go.txt
...
func indexFor(s string, pos syntax.Pos) int {
	...
	return i + int(position(pos).Col-1) // columns are 1-based
}
...
func TestModuleVersion(t *testing.T) {
	...
	goversion := fmt.Sprintf("go1.%d", goVersionMinor)

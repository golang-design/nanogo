...
// Source: ../upstream/types2/example_test.go.txt
...
`,
	...
	conf := types2.Config{Fset: testFset, Importer: defaultImporter()}
...
func fib(x int) int {
	...
	for expr, tv := range info.Types {
		var buf strings.Builder
		posn := position(syntax.StartPos(expr))

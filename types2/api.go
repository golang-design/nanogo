...
// Source: ../upstream/types2/api.go.txt
...
func (err Error) FullError() string {
	return fmt.Sprintf("%s: %s", err.Position, err.Full)
}
...
type Info struct {
	...
	FileVersions map[*syntax.SrcFile]string
}
...
// Precondition 1: the Types map is populated.

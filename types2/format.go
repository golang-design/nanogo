...
// Source: ../upstream/types2/format.go.txt
...
func sprintf(fset *syntax.FileSet, qf Qualifier, tpSubscripts bool, format string, args ...any) string {
...
func (check *Checker) sprintf(format string, args ...any) string {
	...
	return sprintf(check.fset(), qf, false, format, args...)
}

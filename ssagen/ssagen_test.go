...
func TestTheAssignmentHasToBeThere(t *testing.T) {
	...
	pl, err := e.resultPlaces(e.a.Target, 0, []*ir.Type{f64, typeInt})
	if err != nil {
	...
	if pl, err := e.resultPlaces(e.a.Target, 0, []*ir.Type{empty}); err != nil || len(pl) != 1 || pl[0].inReg {
	...
	if _, err := e.resultPlaces(e.a.Target, 0, []*ir.Type{big}); err == nil {

...
536 packages of the Go distribution, 41,516 functions and 4,252,983 nodes. The
...
| --- | --- |
| reach SSA construction with no lowering pass | 20,916 |
| get past construction once the lowering pass has run, which is what the driver does | 40,830 |
| lower completely to arm64 machine operations | 20,857 |
| carry a stack map | 20,857 |

**20,916 of those functions reach SSA construction** without the pass. 20,857
of the 20,916 carry a stack map, over 120,493 safepoints, and 10,727 of them
...
were 25,036 refusals and one miscompile. The corpus now reports 20,916 reaching
SSA and 20,857 lowering, so the identity that held while the accepted set was
